...
import { getAWSRegion } from '../utils/ksaCompliance.js'

// Force KSA region if KSA mode enabled
...
console.log(`AWS S3 configured for region: ${awsRegion} (KSA Mode: ${process.env.KSA_HIGH_SECURITY_MODE !== 'false'})`)
